                ...
                <div className="row">
                  <div className="col-xl-5 col-lg-5 mb-30">
                    <div className="case-details-text">
                      ...
                      <span>
                        Our expertise allows business owners to reap the benefits of tapping our IT speciists without having to hire a full-time
                        emploee. In ation, it also reduces the risks associated with not properly maintaining core
                      </span>
                  ...
                  <div className="col-xl-7 col-lg-7 mb-30">
                    <div className="case-details-content">
                      <p>
                        Must explain to you how all this mistaken idea denouncing pleasure and praising pain was born and I will give you a complete
              ...
              <div className="col-xl-12">
                <div className="case-studies-info">
                  <p>
                    ...
                    esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatu
                  </p>
                </div>
              </div>
            </div>
