  ...
  return (
    <Accordion className="accodion-style--1" preExpanded={'0'}>
      <AccordionItem>
        ...
        <AccordionItemPanel>
          <p>
            Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium mque laudantium, totam rem aperiam, eaque ipsa quae ab illo
            inventore veritatis et quasi artecto beatae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas aspernatur aut odit aut fugit
          </p>
        </AccordionItemPanel>
      </AccordionItem>
